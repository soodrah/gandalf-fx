...
public class GlobalConstants {
	...
	public static final String SHUTDOWN_DAY = "FRIDAY";
	public static final String OFF_DAY = "SATURDAY";
	public static final int START_HOUR = 17;  
	public static final int START_MINUT = 05;
	public static final int SHUTDOWN_HOUR = 16;
